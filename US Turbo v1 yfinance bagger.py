...
st.set_page_config(layout="wide", page_title="Mesin Presisi US v1.0", page_icon="⚡", initial_sidebar_state="collapsed")
...
raw_stocks = [
    ...
    # ── FAANG ALTERNATIVES & PURE TECH ──
    "SHOP","SQ","PYPL","UBER","LYFT","ABNB","DASH","SNAP","PINS","TWTR",
    "RBLX","U","NET","DDOG","SNOW","CRWD","ZS","PANW","FTNT","OKTA",
    "MDB","TEAM","WDAY","HUBS","ZM","DOCU","TWLO","PATH","AI","SMCI",
    # ── AI / DATA ──
    "PLTR","C3AI","SOUN","BBAI","UPST","ASAN","ESTC","CFLT","S","GTLB",
    # ── EV & BATTERY ──
    "TSLA","RIVN","LCID","NIO","XPEV","LI","CHPT","BLNK","QS","SLDP",
    "FSR","WKHS","NKLA","HYZN","PLUG","FCEL","BE","ALB","SQM","LAC",
    # ── CHINA ADR ──
    "BABA","JD","PDD","BIDU","NTES","BILI","TCEHY","NIO","XPEV","LI",
    "TME","BEKE","TAL","EDU","IQ","HUYA","DOYU","GDS","VIPS","YMM",
    # ── BIOTECH BIG ──
    "MRNA","BNTX","BIIB","VRTX","REGN","ILMN","ALNY","SGEN","INCY","BMRN",
    "EXEL","TECH","CRSP","NTLA","BEAM","EDIT","SANA","BLUE","RPRX","JAZZ",
    # ── HEALTHCARE / PHARMA ──
    "JNJ","PFE","ABBV","MRK","BMY","LLY","ABT","TMO","CVS","CI","HUM",
    "ANTM","GILD","AMGN","BIIB","REGN","VRTX","ALXN","MRNA","BNTX","NVAX",
    # ── FINANCIAL / FINTECH ──
    "JPM","BAC","WFC","C","GS","MS","SCHW","AXP","BLK","SPGI","ICE","CME",
    "BX","KKR","APO","CG","COIN","HOOD","SOFI","AFRM","UPST","SQ","PYPL",
    "MKTX","NDAQ","TROW","STT","BK","V","MA","FIS","FISV","GPN","WU",
    # ── ENERGY ──
    "XOM","CVX","COP","EOG","OXY","SLB","PXD","MPC","VLO","PSX",
    "HES","DVN","FANG","APA","CTRA","MRO","KMI","WMB","ENB","ET",
    "TPL","HAL","BKR","NOV","RIG","NE","VAL","TS","NEX","WHD",
    # ── CONSUMER DISCRETIONARY ──
    "AMZN","TSLA","HD","NKE","MCD","SBUX","TJX","LOW","BKNG","TM",
    "CMG","ORLY","AZO","ROST","LULU","BURL","DPZ","YUM","CMG","DRI",
    "GM","F","RIVN","LCID","HOG","TSLA","CARG","CVNA","KMX","AN",
    # ── CONSUMER STAPLES ──
    "PG","KO","PEP","WMT","COST","PM","MO","CL","KMB","GIS","K","HSY",
    "STZ","TAP","SAM","DEO","BUD","KDP","MNST","CHD","CLX","ENR",
    # ── COMMUNICATION / MEDIA ──
    "META","GOOGL","NFLX","DIS","CMCSA","T","VZ","TMUS","CHTR","WBD",
    "FOX","FOXA","NWS","NWSA","PARA","SIRI","LSXMA","LSXMK","BIDU","TME",
    # ── INDUSTRIALS ──
    "BA","CAT","DE","HON","UPS","FDX","RTX","LMT","NOC","GD","TXT",
    "EMR","ETN","ITW","PH","CMI","ROK","DOV","FTV","XYL","AME",
    "WM","RSG","WCN","CSX","UNP","NSC","CHRW","JBHT","EXPD","ODFL",
    # ── REAL ESTATE / REITS ──
    "PLD","AMT","CCI","EQIX","DLR","O","SPG","WELL","PSA","EXR",
    "AVB","EQR","ESS","INVH","SBAC","ARE","VTR","VICI","HST","REG",
    # ── UTILITIES ──
    "NEE","SO","DUK","CEG","SRE","AEP","D","PCG","EXC","XEL","PEG","ED",
    # ── MATERIALS / METALS ──
    "LIN","APD","SHW","FCX","NEM","NUE","STLD","DOW","DD","ECL","PPG",
    "GOLD","AEM","KGC","AG","PAAS","HL","CDE","WPM","FNV","RGLD",
    "X","CLF","MT","RIO","BHP","VALE","SCCO","TECK","ALB","SQM","LAC",
    # ── CRYPTO-RELATED ──
    "COIN","MSTR","MARA","RIOT","CLSK","HUT","BITF","CIFR","CAN","BTBT",
    "WULF","HIVE","DGHI","NCTY","BTCS","SOS","EBON","CIPHER","HOOD","SQ",
    # ── MEME / RETAIL FAVS ──
    "GME","AMC","BB","NOK","WISH","CLOV","SOFI","HOOD","PLTR","SPCE",
    "TLRY","CGC","CRON","ACB","HEXO","SNDL","CURLF","TCNNF","GTBIF","VFF",
    "DWAC","CFVI","PHUN","BBBY","ATER","BBIG","PROG","MULN","FFIE","HKD",
    # ── DEFENSE / AEROSPACE ──
    "LMT","NOC","RTX","GD","BA","TXT","HII","KTOS","AVAV","LHX",
    "TDG","HEI","ESLT","BWXT","CW","MRCY","LDOS","SAIC","BAH","CACI",
    # ── TRAVEL / LEISURE ──
    "BKNG","ABNB","MAR","HLT","H","IHG","WH","CHH","RCL","CCL",
    "NCLH","UAL","DAL","AAL","LUV","ALK","JBLU","HA","SAVE","ALGT",
    "MGM","WYNN","LVS","CZR","DKNG","PENN","BYD","CHDN","RRR","FLL",
    # ── CYBERSECURITY ──
    "CRWD","PANW","ZS","FTNT","OKTA","S","NET","CYBR","TENB","RPD","FEYE",
    # ── CLEAN ENERGY ──
    "ENPH","SEDG","FSLR","RUN","NOVA","SPWR","CSIQ","JKS","ARRY","SHLS",
    "PLUG","FCEL","BE","BLDP","HYG","NEE","BEPC","TAN","ICLN","QCLN",
    # ── E-COMMERCE / SAAS ──
    "AMZN","SHOP","ETSY","EBAY","W","CHWY","CVNA","MELI","JD","BABA",
    # ── POPULAR MID/SMALL CAP ──
    "NIO","AFFIRM","UPST","ROKU","SOFI","PLBY","SKLZ","OPEN","Z","RDFN",
    "WBA","KSS","M","JWN","GPS","BIG","DLTR","FIVE","OLLI","ULTA",
    "BBWI","TPR","CPRI","RL","LEVI","PVH","HBI","UAA","CROX","ONON",
    # ── TOP ETFs ──
    "SPY","QQQ","IWM","DIA","VTI","VOO","VEA","VWO","BND","TLT",
    "GLD","SLV","USO","UNG","DBC","DBA","XLE","XLF","XLK","XLV",
    "XLI","XLY","XLP","XLU","XLB","XLRE","XLC","ARKK","ARKG","ARKW",
    "ARKQ","ARKF","SOXX","SMH","IBB","XBI","KRE","KBE","XOP","OIH",
    "TQQQ","SQQQ","SOXL","SOXS","TNA","TZA","UPRO","SPXS","UDOW","SDOW",
    "VXX","UVXY","SVXY","SVOL","JEPI","JEPQ","SCHD","DGRO","VYM","DVY",
]
...
def get_market_regime():
    try:
        df = _fetch_yf_ticker("^GSPC", "60d", "1d")  # ← no yf.download!
        if df is None or len(df) < 10:
            return ("UNKNOWN", 0, 0, 0, "Data SPX kurang", 0.0)
        ...
        if above_e20_clear and above_e55:
            return ("GREEN", price, ema20, ema55, f"SPX {price:,.0f} > EMA20 & EMA55 → Bullish ✅ ({pct_vs_e20:+.1f}% vs EMA20)", chg)
        elif above_e20_any and above_e55:
            return ("GREEN", price, ema20, ema55, f"SPX {price:,.0f} dekat EMA20 & di atas EMA55 → Bullish", chg)
        elif above_e20_any and not above_e55:
            return ("SIDEWAYS", price, ema20, ema55, f"SPX {price:,.0f} > EMA20 tapi < EMA55({ema55:,.0f}) → Sideways", chg)
        elif not above_e20_any and recovering:
            return ("SIDEWAYS", price, ema20, ema55, f"SPX {price:,.0f} recovery {chg:+.2f}% → Sideways", chg)
        elif bearish_confirm:
            return ("RED", price, ema20, ema55, f"SPX {price:,.0f} < EMA20({ema20:,.0f}) {pct_vs_e20:+.1f}% → Bearish", chg)
        else:
            return ("SIDEWAYS", price, ema20, ema55, f"SPX {price:,.0f} sedikit di bawah EMA20 → Sideways", chg)
    except Exception as e:
        return ("UNKNOWN", 0, 0, 0, f"SPX error: {str(e)[:40]}", 0.0)

def get_regime_config(regime):
    # Threshold realistis — sebelumnya terlalu ketat (min_rvol 2.0 = 90% stocks gak lolos)
    return {
        ...
        "GREEN":   {"mode":"Bagger 💎","min_score":3,"min_rvol":1.3,"sl_mult":0.8,
                    "label":"🟢 MARKET HIJAU — Wyckoff Accumulation Hunt, Score ≥ 3","color":"#00ff88",
...
def send_telegram(results_top, source="Scanner"):
    ...
    now=datetime.now(et_tz); is_open=9<=now.hour<16; sep="━"*28
    ...
    footer=f"\n{sep}\n⚡ _Mesin Presisi US v1.0 · TT 15M × IQ Daily_\n⚠️ _BUKAN saran investasi!_"
    try:
...
SECTORS={
    "Mega-Cap Tech":      ["AAPL","MSFT","GOOGL","AMZN","NVDA","META","TSLA","AVGO","ORCL","CRM","ADBE","NFLX"],
    "Semiconductor":      ["NVDA","AMD","TSM","ASML","AVGO","INTC","QCOM","MU","LRCX","KLAC","AMAT","MRVL","NXPI","MCHP","ON","SMCI"],
    "Banks & Finance":    ["JPM","BAC","WFC","C","GS","MS","BLK","SCHW","AXP","V","MA","SPGI","ICE","CME","COF","USB"],
    "Software & Cloud":   ["MSFT","CRM","NOW","ORCL","ADBE","SNOW","DDOG","CRWD","ZS","PANW","NET","MDB","WDAY","TEAM","HUBS"],
    "AI & Data":          ["NVDA","PLTR","AI","SOUN","BBAI","UPST","SMCI","SNOW","DDOG","NET","S","ESTC","ASAN","CFLT"],
    "Healthcare & Pharma":["UNH","LLY","JNJ","ABBV","MRK","TMO","PFE","ABT","DHR","BMY","ELV","CI","HUM","CVS","GILD","AMGN"],
    "Biotech":            ["MRNA","BNTX","VRTX","REGN","BIIB","ILMN","ALNY","INCY","BMRN","EXEL","CRSP","NTLA","BEAM","EDIT"],
    "Energy & Oil":       ["XOM","CVX","COP","EOG","SLB","OXY","PXD","MPC","VLO","PSX","HES","DVN","FANG","KMI","WMB"],
    "Consumer Discr.":    ["AMZN","TSLA","HD","NKE","MCD","SBUX","TJX","LOW","BKNG","CMG","ORLY","AZO","ROST","LULU","ABNB"],
    "Consumer Staples":   ["PG","KO","PEP","WMT","COST","PM","MO","CL","KMB","GIS","K","HSY","STZ","KDP","MNST"],
    "EV & Battery":       ["TSLA","RIVN","LCID","NIO","XPEV","LI","CHPT","BLNK","QS","PLUG","FCEL","ALB","SQM","LAC"],
    "China ADR":          ["BABA","JD","PDD","BIDU","NTES","BILI","NIO","XPEV","LI","TME","BEKE","TAL","EDU","IQ"],
    "Crypto Stocks":      ["COIN","MSTR","MARA","RIOT","CLSK","HUT","BITF","CIFR","HOOD","SQ","BTBT","WULF","HIVE"],
    "Defense & Aero":     ["LMT","NOC","RTX","GD","BA","TXT","HII","KTOS","AVAV","LHX","TDG","HEI","LDOS","SAIC"],
    "Cybersecurity":      ["CRWD","PANW","ZS","FTNT","OKTA","S","NET","CYBR","TENB","RPD"],
    "Clean Energy":       ["ENPH","SEDG","FSLR","RUN","NOVA","SPWR","CSIQ","ARRY","SHLS","PLUG","FCEL","BE","NEE","BEPC"],
    "REIT":               ["PLD","AMT","CCI","EQIX","DLR","O","SPG","WELL","PSA","EXR","AVB","EQR","INVH","SBAC","ARE","VICI"],
    "Travel & Leisure":   ["BKNG","ABNB","MAR","HLT","H","RCL","CCL","NCLH","UAL","DAL","AAL","LUV","MGM","WYNN","LVS","DKNG"],
    "Industrials":        ["BA","CAT","DE","HON","UPS","FDX","RTX","LMT","GE","EMR","ETN","ITW","PH","CMI","ROK","DOV"],
    "Materials & Metals": ["LIN","APD","SHW","FCX","NEM","NUE","STLD","DOW","DD","ECL","PPG","GOLD","AG","X","CLF","ALB","SQM"],
    "Meme & Retail":      ["GME","AMC","BB","SOFI","HOOD","PLTR","SPCE","TLRY","CGC","SNDL","DWAC","BBBY","MULN","FFIE"],
    "Communication":      ["META","GOOGL","NFLX","DIS","CMCSA","T","VZ","TMUS","CHTR","WBD","PARA","SIRI","ROKU","SPOT"],
    "Top ETFs":           ["SPY","QQQ","IWM","DIA","VTI","VOO","XLE","XLF","XLK","XLV","XLI","XLY","XLP","XLU","XLB","XLRE","SOXX","SMH","ARKK","TQQQ","SQQQ","SOXL","TLT","GLD","SLV","USO"],
}
HIGH_BETA_SECTORS=["AI & Data","Semiconductor","EV & Battery","Crypto Stocks","Biotech","Meme & Retail"]
...
now_et=datetime.now(et_tz); is_open=9<=now_et.hour<16

st.markdown(f"""<div class="tt-header">
  <div><div class="tt-logo">⚡ MESIN PRESISI US 🇺🇸</div>
  <div class="tt-sub">TT 15M × US Quant Daily (151 Strategies) · v1.0 · Zero Rate Limit ✅</div></div>
...
st.markdown(f"""<div style="background:rgba(0,0,0,.4);border:1px solid {rcolor}44;border-radius:8px;padding:12px 16px;margin-bottom:14px;border-left:4px solid {rcolor};">
  <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
    ...
    <div style="text-align:right;font-family:Space Mono,monospace;">
      <div style="font-size:18px;font-weight:700;color:{rcolor};">{spx_price:,.0f} <span style="font-size:11px;color:{chg_col}">{chg_sym}{abs(spx_chg):.2f}%</span></div>
...
tab_scanner,tab_watchlist,tab_bsjp,tab_sector,tab_gapup,tab_trail,tab_backtest=st.tabs(
    ["🔥 Scanner","👁️ Watchlist","🌙 Overnight","🏭 Sektor","📈 Gap Up","🎯 Trailing Stop","📊 Backtest"])
...
with tab_scanner:
    ...
    if do_diagnosa:
        with st.expander("🔧 DIAGNOSTIK yFinance", expanded=True):
            ...
            # test 15m
            _r15 = _fetch_yf_ticker("AAPL","5d","15m")
            if _r15 is not None:
        ...
        try:
            ...
            if len(data_dict)==0:
                ...
                with st.expander("🔧 DIAGNOSTIK — klik untuk cek koneksi", expanded=True):
                    ...
                    st.caption("Test fetch AAPL...")
                    _test_df = _fetch_yf_ticker("AAPL", "5d", "1d")
                    if _test_df is not None:
                        st.success(f"✅ AAPL OK — {len(_test_df)} rows, cols: {_test_df.columns.tolist()}")
                        st.caption("yFinance bisa fetch data. Kemungkinan masalah di paralel. Coba SCAN lagi.")
                    else:
                        st.error("❌ AAPL juga gagal! Cek:\n- Internet Streamlit Cloud OK?\n- Coba tambahkan `yfinance==0.2.61` di requirements.txt")
                    # Test download() as last resort
                    try:
                        _td2 = yf.download("AAPL","5d","1d",progress=False,threads=False)
                        if not _td2.empty:
    ...
    if not results and not do_scan_btn and not auto_trigger:
        ...
        st.markdown(f"""<div class="metric-row">
          <div class="metric-card" style="border-top-color:{rcolor}"><div class="metric-label">Regime</div>
            ...
            <div class="metric-sub">{spx_price:,.0f} {chg_sym}{abs(spx_chg):.2f}%</div></div>
...
<div style="background:linear-gradient(135deg,rgba(0,255,136,.04),rgba(191,95,255,.04));border:1px solid rgba(0,255,136,.25);border-radius:10px;padding:12px 16px;margin-bottom:12px;">
  <div style="font-family:Space Mono,monospace;font-size:11px;font-weight:700;color:#00ff88;letter-spacing:2px;margin-bottom:10px;">
    MESIN PRESISI US v1.0 — 15M x DAILY ALIGNMENT (151 Strategies)
  </div>
  ...
  <div style="background:#0d1117;border:1px solid #1c2533;border-radius:8px;padding:8px 14px;flex:1;min-width:100px">
    ...
    <div style="font-size:9px;color:#4a5568">IDX yFinance OHLCV</div>
        ...
        st.markdown(
            ...
            f'Mesin Presisi US v1.0 — TT 15M x IDX Quant Daily (151 Strategies) — Zero Rate Limit</div>'
            f'</div>',
...
with tab_bsjp:
    ...
    with bc1:
        bsjp_min_score=st.slider("Min Overnight Score",0,6,4,key="bsjp_score")
    ...
    do_bsjp=st.button("🌙 SCAN OVERNIGHT SEKARANG",type="primary",use_container_width=True,key="btn_bsjp")
    if do_bsjp:
        bsjp_res=[]; scan_data=st.session_state.get("data_dict",{})
        if not scan_data:
            st.info("Fetching data untuk overnight play...")
        ...
        for i,ty in enumerate(tbs):
            ...
            try:
                ...
                e9=float(r["EMA9"]); e21=float(r["EMA21"]); e50=float(r["EMA50"])
                trend="▲ UP" if e9>e21>e50 else("▼ DOWN" if e9<e21<e50 else "◆ SIDE")
                bsjp_res.append({"Ticker":stock_map.get(ty,ty),"Price":int(close),
    ...
    if br:
        ...
        st.markdown('<div style="text-align:center;padding:48px;color:#4a5568;font-family:Space Mono,monospace;"><div style="font-size:32px;margin-bottom:12px;">🌙</div><div>KLIK SCAN OVERNIGHT</div></div>',unsafe_allow_html=True)
...
with tab_trail:
    ...
    with tc1:
        ...
        tr_t=st.text_input("Ticker",value="AAPL",key="tr_ticker").upper()
...
st.markdown(f"""<div style="margin-top:28px;padding-top:14px;border-top:1px solid #1c2533;display:flex;justify-content:space-between;flex-wrap:wrap;gap:8px;">
  <div style="font-family:Space Mono,monospace;font-size:10px;color:#4a5568;">🔥 Mesin Presisi US v1.0 · TT 15M × US Quant (151 Strategies) · Zero Rate Limit ✅</div>
